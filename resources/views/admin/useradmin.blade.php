            ...
            <div class="container mx-auto px-6 py-8">
                ...
                <!-- Search input field -->
                    <div class="flex items-center mb-4">
                        ...
                        <input type="text" id="searchInput" class="px-3 py-2 border rounded-md focus:outline-none focus:ring-blue-500 focus:ring-1" placeholder="Search by name or email">
                    </div>
                <div class="mt-8">
