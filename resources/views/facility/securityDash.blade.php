...
<head>
    ...
    <title>Security RescueWing</title>
    ...
    <script>
        ...
        var channel = pusher.subscribe('secu-channel');
        channel.bind('form-secu', function(data) {
            Swal.fire({
                title: 'EMERGENCY!',
                html: `Security Type: ${data.result.security_type}<br>Name: ${data.result.name}<br>Latitude: ${data.result.latitude}<br>Longitude: ${data.result.longitude}<br><div id="map-container" style="height: 400px;"></div>`, // Container for the map
                icon: 'warning',
                ...
                <td class="border px-4 py-2">${data.result.security_type}</td>
...
<body class="bg-blue-900">
    <div class="relative min-h-screen md:flex">
        ...
        <div class="bg-blue-800 text-white font-bold text-lg flex justify-between md:hidden">
            ...
            <a href="#" class="block p-4 text-white font-bold">Security RescueWing</a>
        ...
        <div class="sidebar bg-white text-blue-900 w-64 space-y-6 py-7 px-2 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out overflow-y-auto">
            ...
            <a href="#" class="text-blue-900 flex items-center space-x-2 px-4">
                ...
                <span class="text-2xl font-extrabold">Security RescueWing</span>
            </a>
                            ...
                            <table class="table-auto">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="px-4 py-2">Security Type</th>
